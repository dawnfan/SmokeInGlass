...
void Image::init()
{
	...
	// ground plane
	my_primitive[0] = new Plane(Vector3(0, 1, 0), 6.0f);
	my_primitive[0]->getMaterial()->setReflection(0.0f);
	my_primitive[0]->getMaterial()->setRefraction(0.0f);
	my_primitive[0]->getMaterial()->setDiffusion(1.0f);
	my_primitive[0]->getMaterial()->setColor(Color(0.9f, 0.2f, 0.1f));
	// big sphere
	my_primitive[1] = new Sphere(Vector3(2, 0.4f, 3), 3.5f);
	my_primitive[1]->getMaterial()->setReflection(0.2f);
	my_primitive[1]->getMaterial()->setRefraction(0.8f);
	my_primitive[1]->getMaterial()->setRefrIndex(1.3f);
	my_primitive[1]->getMaterial()->setDiffusion(0.7f);
	my_primitive[1]->getMaterial()->setColor(Color(0.7f, 0.7f, 0.7f));
	// inside big sphere
	my_primitive[7] = new Sphere(Vector3(2, 0.4f, 3), 3.1f);
	my_primitive[7]->getMaterial()->setReflection(0.2f);
	my_primitive[7]->getMaterial()->setRefraction(0.8f);
	my_primitive[7]->getMaterial()->setRefrIndex(1.0f);
	my_primitive[7]->getMaterial()->setColor(Color(0.7f, 0.7f, 0.7f));
	// small sphere
	my_primitive[2] = new Sphere(Vector3(-5.5f, -1.5, 7), 2);
	my_primitive[2]->getMaterial()->setReflection(0.5f);
	my_primitive[2]->getMaterial()->setRefraction(0.0f);
	my_primitive[2]->getMaterial()->setRefrIndex(1.3f);
	my_primitive[2]->getMaterial()->setDiffusion(0.7f);
	my_primitive[2]->getMaterial()->setColor(Color(0.7f, 0.7f, 1.0f));
	// light source 1
	my_primitive[3] = new Sphere(Vector3(0, 5, 5), 0.01f);
	my_primitive[3]->setLight(true);
	my_primitive[3]->getMaterial()->setColor(Color(0.7f, 0.7f, 0.7f));
	// light source 2
	my_primitive[4] = new Sphere(Vector3(-3, 5, 1), 0.01f);
	my_primitive[4]->setLight(true);
	my_primitive[4]->getMaterial()->setColor(Color(0.8f, 0.8f, 0.8f));
	// extra sphere
	my_primitive[5] = new Sphere(Vector3(-4.0f, 3.0f, 6), 1.5f);
	...
	my_primitive[5]->getMaterial()->setColor(Color(0.7f, 0.7f, 0.7f));
	// back plane
	my_primitive[6] = new Plane(Vector3(0, 0, -1), 12);
	...
	my_primitive[6]->getMaterial()->setColor(Color(0.9f, 0.9f, 0.1f));
	// ceiling plane
	//my_primitive[7] = new Plane(Vector3(0, -1, 0), 7.0f);
	...
	{
		my_primitive[prim] = new Sphere(Vector3(-1.5f + x * 1.5f, -3.0f + y * 1.5f, 10), 0.25f);
		...
		my_primitive[prim]->getMaterial()->setColor(Color(0.2f, 0.2f, 1.0f));
		prim++;
	}
	// smoke sphere
	my_primitive[prim] = new Sphere(Vector3(2, 0.4f, 3), 3.0f);
